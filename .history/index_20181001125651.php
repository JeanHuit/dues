...
<html>
 ...
 <div class="container-fluid">
      ...
      <!-- Second form to simpl poll all members who owe -->
      <form class="form-group" action="" method ="post">
      <div class="row">
          <div class="col-lg-4">
            <button class="btn btn-primary btn-lgt" type="submit" name="action">Poll Debtors</button>
          </div>
        </div>
        <br>
        <div class="row">
          <div class="col-lg-6 table-responsive">
            ...
            $sql = "SELECT * FROM Dues_tbl WHERE Time_payed LIKE '%".$term."%'";
            $r_query = mysqli_query($db,$sql);
